...
const CustomerLiveMap = () => {
  ...
  const customerCoords =
    currentCustomer?.defaultLocation?.coordinates?.length >= 2
      ? [
          currentCustomer.defaultLocation.coordinates[1],
          currentCustomer.defaultLocation.coordinates[0],
        ]
      : null;

  const defaultCenter = customerCoords || [28.6139, 77.209];
    ...
    <div className="h-[360px]">
      ...
      >
        ...
        {activeOrders.map((order) => {
          const coords =
            order.driver?.liveLocation?.coordinates;
